...
`sim/memory_ops.py`, `AgentState.memories` / `soul`, `world.data` conversations and summaries. Self-care uses Ollama to summarize batches when ≥30 memories. See [LOCAL_SIM.md](./LOCAL_SIM.md).
